...
import { farmListDom,farmCountDom, farmReadytDom, farmStartedDom, regex, selectAllFarmsDom, iframeInfo, mainGameUrl, farmUrl } from './consts';
...
export function openFarm(farmNumber) {
    window.open(`${mainGameUrl}${farmUrl}${farmNumber}`, "_blank");
}
...
export function createFarmNode(farm) {
    ...
    tag.innerHTML = `  <div class="container input">
        ...
        <div class="container action">
            ...
            <a href="${mainGameUrl}${farmUrl}${farm.number}" target="_blank" class="open-farm btn-icon text btn" title="Open Farm">
