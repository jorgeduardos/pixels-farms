...
var dev = false;
var storedFarms = JSON.parse(localStorage.getItem(_consts__WEBPACK_IMPORTED_MODULE_3__.defaultFarmKey));
var FARMS = [];
var FARMStoUpdate = []; // ************************************** //
//             GENERATE FARMS             //
// ************************************** //
...
var sortable = new sortablejs__WEBPACK_IMPORTED_MODULE_1__["default"](_consts__WEBPACK_IMPORTED_MODULE_3__.farmListDom, {
  ...
  onEnd: function onEnd(e) {
    ...
    localStorage.setItem(_consts__WEBPACK_IMPORTED_MODULE_3__.defaultFarmKey, JSON.stringify(FARMS));
...
addForm.addEventListener('submit', function (e) {
  ...
  (0,_farm_helpers__WEBPACK_IMPORTED_MODULE_7__.addFarm)(e.target, formProps, FARMS, _consts__WEBPACK_IMPORTED_MODULE_3__.defaultFarmKey, dev);
}); // **************************************  //
//             ADD COLOR                   //
// ************************************** //
...
_consts__WEBPACK_IMPORTED_MODULE_3__.farmListDom.addEventListener('click', function (e) {
  ...
  if (e.target.classList.contains('start-farm')) {
    ...
    (0,_farm_events__WEBPACK_IMPORTED_MODULE_6__.startFarm)(e.target, FARMS, _consts__WEBPACK_IMPORTED_MODULE_3__.defaultFarmKey);
  } else if (e.target.classList.contains('delete-farm')) {
    //delete frm from farm-events.js
    (0,_farm_events__WEBPACK_IMPORTED_MODULE_6__.deleteFarm)(e.target, FARMS, _consts__WEBPACK_IMPORTED_MODULE_3__.defaultFarmKey, dev);
    ...
    var farm = (0,_farm_helpers__WEBPACK_IMPORTED_MODULE_7__.findFarm)(farmDom.id, FARMS).farm;
    var nextDomE = farmDom.nextElementSibling;
    farm.startTime = null;
    farm.timer = null; //remove farm

    farmDom.remove(); //build dom el
...
document.querySelectorAll('.edit-farms').forEach(function (form) {
  form.addEventListener('submit', function (e) {
    ...
    if (typeOfEdit == 'obj') {
      ...
      (0,_farm_helpers__WEBPACK_IMPORTED_MODULE_7__.updateFarmDom)(farm, formProps, FARMS, _consts__WEBPACK_IMPORTED_MODULE_3__.defaultFarmKey);
...
_consts__WEBPACK_IMPORTED_MODULE_3__.exportAllFarms.addEventListener('click', function (e) {
  if (FARMS.length > 0) {
    var farmsToExport = localStorage.getItem(_consts__WEBPACK_IMPORTED_MODULE_3__.defaultFarmKey);
...
importForm.addEventListener('submit', function (e) {
  ...
  fr.onload = function () {
    // importForm.querySelector('p').innerHTML = `<span>Click here to upload </span> or drag and drop <br>txt file`;
    // importForm.querySelector('button').disabled = false;
    (0,_misc__WEBPACK_IMPORTED_MODULE_5__.importClean)(fr.result, FARMS, _consts__WEBPACK_IMPORTED_MODULE_3__.defaultFarmKey);
  };
}); // ************************************** //
//              ACCOIRDIONS               //
// ************************************** //
