...
var CROPS = [{
  ...
  sproutTimeSeconds: 7200 // sproutTimeSeconds: 70
...
function startFarm(button, farms, localStorageKey) {
  ...
  timer.addEventListener('targetAchieved', function (e) {
    ...
    farmDom.classList.remove('started'); // updateFarmCount(farms);
...
function deleteFarm(button, farms, localStorageKey) {
  ...
  localStorage.setItem(localStorageKey, JSON.stringify(farms));
  farmDom.remove(); // updateFarmCount(farms);
}
...
function addFarm(formDom, form, farms, localStorageKey) {
  ...
  farms.push(farm); // updateFarmCount(farms);
  //reset form fields
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "w3gFarms": () => (/* binding */ w3gFarms)
/* harmony export */ });
var w3gFarms = [{
  number: "2366",
  crop: {
  ...
  info: {
    color: null,
    notes: "18 plots - Tamis - links back to 3540"
  }
}];
...
/* harmony import */ var _w3gFarms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./w3gFarms */ "./src/js/w3gFarms.js");
...
/* harmony import */ var _consts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./consts */ "./src/js/consts.js");
/* harmony import */ var _crops__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./crops */ "./src/js/crops.js");
/* harmony import */ var _misc__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./misc */ "./src/js/misc.js");
/* harmony import */ var _farm_events__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./farm-events */ "./src/js/farm-events.js");
/* harmony import */ var _farm_helpers__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./farm-helpers */ "./src/js/farm-helpers.js");
...
var localStoreCheck = JSON.parse(localStorage.getItem(_consts__WEBPACK_IMPORTED_MODULE_4__.w3gFarmKey));

if (localStoreCheck == null || localStoreCheck.length == 0) {
  localStorage.setItem(_consts__WEBPACK_IMPORTED_MODULE_4__.w3gFarmKey, JSON.stringify(_w3gFarms__WEBPACK_IMPORTED_MODULE_1__.w3gFarms));
} // is in dev mode to print console logs


var dev = false;
var storedFarms = JSON.parse(localStorage.getItem(_consts__WEBPACK_IMPORTED_MODULE_4__.w3gFarmKey));
var FARMS = [];
var FARMStoUpdate = []; // ************************************** //
//             GENERATE FARMS             //
// ************************************** //
...
if (storedFarms != null) {
  ...
  FARMS.forEach(function (farm) {
    ...
    if (farm.crop.sproutTimeSeconds == undefined) {
      _crops__WEBPACK_IMPORTED_MODULE_5__["default"].forEach(function (crop) {
    ...
    _consts__WEBPACK_IMPORTED_MODULE_4__.farmListDom.appendChild((0,_farm_helpers__WEBPACK_IMPORTED_MODULE_8__.createFarmNode)(farm));

    if (farm.startTime != undefined && farm.startTime != null) {
      // console.log('continuing farm timer')
      (0,_farm_helpers__WEBPACK_IMPORTED_MODULE_8__.continueFarmTimer)(farm);
    }
  }); //update far counters after creating farm nodes
  // updateFarmCount(FARMS);

  if (FARMS.length > 1) {
    _consts__WEBPACK_IMPORTED_MODULE_4__.selectAllFarmsDom.disabled = false;
  }
} // ************************************** //
//                SORTABLE                //
// ************************************** //
...
var sortable = new sortablejs__WEBPACK_IMPORTED_MODULE_2__["default"](_consts__WEBPACK_IMPORTED_MODULE_4__.farmListDom, {
  animation: 150,
  ghostClass: 'ghost',
  onEnd: function onEnd(e) {
    (0,array_move__WEBPACK_IMPORTED_MODULE_3__.arrayMoveMutable)(FARMS, e.oldIndex, e.newIndex);
    localStorage.setItem(_consts__WEBPACK_IMPORTED_MODULE_4__.w3gFarmKey, JSON.stringify(FARMS));
...
addForm.addEventListener('submit', function (e) {
  ...
  (0,_farm_helpers__WEBPACK_IMPORTED_MODULE_8__.addFarm)(e.target, formProps, FARMS, _consts__WEBPACK_IMPORTED_MODULE_4__.w3gFarmKey, dev);
}); // **************************************  //
//             ADD COLOR                   //
// ************************************** //
...
_consts__WEBPACK_IMPORTED_MODULE_4__.farmListDom.addEventListener('click', function (e) {
  //start farm
  if (e.target.classList.contains('start-farm')) {
    //start farm from farm-events.js
    (0,_farm_events__WEBPACK_IMPORTED_MODULE_7__.startFarm)(e.target, FARMS, _consts__WEBPACK_IMPORTED_MODULE_4__.w3gFarmKey);
  } else if (e.target.classList.contains('delete-farm')) {
    //delete frm from farm-events.js
    (0,_farm_events__WEBPACK_IMPORTED_MODULE_7__.deleteFarm)(e.target, FARMS, _consts__WEBPACK_IMPORTED_MODULE_4__.w3gFarmKey, dev);
  } else if (e.target.classList.contains('open-farm')) {
    var farmDom = e.target.parentElement.parentElement;
    (0,_farm_helpers__WEBPACK_IMPORTED_MODULE_8__.openFarm)(farmDom.id);
  } else if (e.target.classList.contains('edit-farm')) {
    (0,_farm_events__WEBPACK_IMPORTED_MODULE_7__.editSingleFarmForm)(e.target, FARMS);
  } else if (e.target.classList.contains('select-farm')) {
    (0,_farm_events__WEBPACK_IMPORTED_MODULE_7__.selectFarm)(e.target, FARMStoUpdate, FARMS, dev);
  }
}); // ************************************** //
//               POP UPS                  //
// ************************************** //
...
popUps.forEach(function (element) {
  ...
  closePopBtn.addEventListener('click', function () {
    (0,_misc__WEBPACK_IMPORTED_MODULE_6__.closePop)(element);
...
openPopButtons.forEach(function (element) {
  ...
  element.addEventListener('click', function () {
    (0,_misc__WEBPACK_IMPORTED_MODULE_6__.openPop)(popUp);
  });
}); // ************************************** //
//            EDIT FARM FORMS             //
// ************************************** //
...
document.querySelectorAll('.edit-farms').forEach(function (form) {
  form.addEventListener('submit', function (e) {
    ...
    if (typeOfEdit == 'obj') {
      ...
      var farm = (0,_farm_helpers__WEBPACK_IMPORTED_MODULE_8__.findFarm)(farmId, FARMS).farm;
      (0,_farm_helpers__WEBPACK_IMPORTED_MODULE_8__.updateFarmDom)(farm, formProps, FARMS, _consts__WEBPACK_IMPORTED_MODULE_4__.w3gFarmKey);
      (0,_misc__WEBPACK_IMPORTED_MODULE_6__.closePop)(_consts__WEBPACK_IMPORTED_MODULE_4__.editPopUpDom);
      ...
      FARMStoUpdate = [];
      var checkBoxes = _consts__WEBPACK_IMPORTED_MODULE_4__.farmListDom.querySelectorAll('.select-farm');
      var selectButton = document.getElementById('select-all-farms');
      (0,_misc__WEBPACK_IMPORTED_MODULE_6__.clearCheckBoxes)(checkBoxes);
      _consts__WEBPACK_IMPORTED_MODULE_4__.selectAllFarmsDom.checked = false;
      (0,_misc__WEBPACK_IMPORTED_MODULE_6__.closePop)(_consts__WEBPACK_IMPORTED_MODULE_4__.massEditPopUpDom);
    }
  });
}); // ************************************** //
//             FILTER FARMS               //
...
_consts__WEBPACK_IMPORTED_MODULE_4__.filterFarmsDom.addEventListener('click', function (e) {
...
document.getElementById('delete-all-farms').addEventListener('click', function (e) {
  ...
  _consts__WEBPACK_IMPORTED_MODULE_4__.selectAllFarmsDom.checked = false;
  document.querySelector('.bulk-actions').style.display = 'none';
  localStorage.setItem(_consts__WEBPACK_IMPORTED_MODULE_4__.w3gFarmKey, JSON.stringify(FARMS)); // updateFarmCount(FARMS);
}); // ************************************** //
//             MASS STARTING              //
// ************************************** //
...
document.getElementById('start-all-farms').addEventListener('click', function (e) {
  ...
  FARMStoUpdate.forEach(function (farm) {
    ...
    if (!farmDom.classList.contains('started')) {
      ...
      var hourFormat = (0,_misc__WEBPACK_IMPORTED_MODULE_6__.secondsToHourFormat)(farm.crop.sproutTimeSeconds); // // timer.start({ countdown: true, startValues: {seconds: 10} });
      ...
      timer.addEventListener('secondsUpdated', (0,_misc__WEBPACK_IMPORTED_MODULE_6__.handleTimerStart)(timerDom, timer));
      farmDom.classList.add('started');
      timer.addEventListener('targetAchieved', function (e) {
      ...
      (0,_farm_helpers__WEBPACK_IMPORTED_MODULE_8__.openFarm)(farm.number);
    } else {
      farmsStarted += 1;
    }
  });
  ...
  if (farmsStarted == FARMStoUpdate.length) {
    (0,_misc__WEBPACK_IMPORTED_MODULE_6__.showError)('All timers are currently running', 1);
  }
...
_consts__WEBPACK_IMPORTED_MODULE_4__.selectAllFarmsDom.addEventListener('change', function (e) {
  var button = e.target;
  var checkBoxes = _consts__WEBPACK_IMPORTED_MODULE_4__.farmListDom.querySelectorAll('.select-farm');
...
_consts__WEBPACK_IMPORTED_MODULE_4__.exportAllFarms.addEventListener('click', function (e) {
  if (FARMS.length > 0) {
    var farmsToExport = localStorage.getItem(_consts__WEBPACK_IMPORTED_MODULE_4__.w3gFarmKey);
    (0,_misc__WEBPACK_IMPORTED_MODULE_6__.download)('exported-farms', farmsToExport);
  }
}); // ************************************** //
//             MASS IMPORT FARMS          //
// ************************************** //
...
importForm.addEventListener('drop', function (e) {
  ...
  if (ext != 'txt') {
    ...
    (0,_misc__WEBPACK_IMPORTED_MODULE_6__.showError)('Unsuported file extension');
    return;
  }
...
importForm.addEventListener('submit', function (e) {
  ...
  fr.onload = function () {
    // importForm.querySelector('p').innerHTML = `<span>Click here to upload </span> or drag and drop <br>txt file`;
    // importForm.querySelector('button').disabled = false;
    (0,_misc__WEBPACK_IMPORTED_MODULE_6__.importClean)(fr.result, FARMS, _consts__WEBPACK_IMPORTED_MODULE_4__.w3gFarmKey);
  };
}); // ************************************** //
//             RESET FARMS                //
// ************************************** //
